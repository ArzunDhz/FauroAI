...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-col items-center text-center text-white bg-neutral-900">
        <div className="container px-6 pt-6">
          ...
          <div className="mb-6">
            <p>
              Provide an email address or a contact form for users to get in
              touch with any questions or feedback.
            </p>
          </div>
        </div>
